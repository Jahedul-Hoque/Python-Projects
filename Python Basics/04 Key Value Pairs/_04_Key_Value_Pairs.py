employeeInfo = {'name': 'Shan', 'Title': "CEO of Schonfeld", "Favourite Coding Languages": ["C++", "Python"], "Salary": 10000000}
...
print("The employees name that you've popped out of the dictionary is", EmployeeName, "\n")
